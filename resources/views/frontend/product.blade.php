...
<section class="container">
  <div class="row">
    <div class="col-md-6 position-relative rounded-4 order-md-2 bg-gradient-1 px-5 pt-5">
      <!-- Image Content -->
      <img src="{{asset('frontend/images/form.png')}}" alt="Section 2 Image" class="img-fluid" />
      <img src="{{asset('frontend/images/car.png')}}" class="position-absolute top-50 start-0  w-50 w-sm-100">
    </div>
...
<section class="container">
  <div class="row">
    <div class="col-md-6  position-relative rounded-4 bg-gradient-1 px-5 pt-5">
      <!-- Image Content -->
      <img src="{{asset('frontend/images/inka.png')}}" alt="Section 3 Image" class="img-fluid" />
...
<section class="container">
  <div class="row">
    <div class="col-md-6 order-md-2 bg-gradient-1 rounded-4 px-5 pt-5">
      <!-- Image Content -->
      <img src="{{asset('frontend/images/kjopikontrakt.png')}}" alt="Section 4 Image" class="img-fluid" />
    </div>
    <div class="col-md-6 order-md-1">
      <!-- Content -->
      <div class="content  d-flex flex-column justify-content-center h-100 p-5">
...
<section class="container">
  <div class="row">
    <div class="col-md-6 rounded-4 bg-gradient-1 px-5 pt-5">
      <!-- Image Content -->
      <img src="{{asset('frontend/images/kontrak.png')}}" alt="Section 5 Image" class="img-fluid" />
    </div>
    <div class="col-md-6">
      <!-- Content -->
    ...
    <div class="col-md-12">
      <div class="heading">
        ...
        <p class="text-center">BankID-brukere er legitimert med pass og du kan være sikker på at en BankID-signering er gjort av en
          ...
          BankID er godkjent etter EU-standarden eIDAS, og identifiseringer og signaturer er gyldige i hele Europa.
        </p>
      </div>
    </div>
  </div>
