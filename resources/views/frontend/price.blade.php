...
<section class="container">
      <div class="row mt-5">
        ...
        <div class="col-md-6">
          ...
          >
            ...
            <a href="#" class="w-25 primary-btn-1"
              >Prøv nå!</a
            >
          </div>
        </div>
    ...
    <!-- devider start -->
    <img
      src="{{asset('frontend/images/homedivider.png')}}"
      class="img-fluid w-100 banner-bottom-divider py-5 d-block"
    />
    <!-- devider end -->

    <div class="container pricecontainer px-2 px-sm-5 position-relative">
      <img
        src="{{asset('frontend/images/circle.png')}}"
        alt=""
        class="position-absolute pricetablecircle"
      />
      <table class="rounded-5 table-responsive-md">
        <thead>
          <tr>
