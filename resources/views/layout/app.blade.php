...
<div class="bg-primary-1 py-2 bg_clr">
      <div class="container">
        <ul
          class="list-unstyled d-flex flex-wrap justify-content-start justify-content-sm-end m-0"
        >
          <li>
            <a href="#" class="topbar-item"
              ><i class="fa-light fa-globe"></i>Norge</a
            >
          </li>
          <li>
            <a href="#" class="topbar-item"
          ...
          <li>
            <a href="#" class="topbar-item"
              ><i class="fa-light fa-messages"></i>Kontakt salg</a
            >
          </li>

          <li>
            <a href="#" class="topbar-item"
              ><i class="fa-light fa-user"></i><a href="{{url('login')}}">Logg in</a></a
            >
          </li>
        </ul>
      </div>
...
<!-- Vendor JS Files -->
  ...
  <script
      ...
      integrity="sha384-WJx2x81h8f1I51wbV9vG+Jjz/sL4XNUa2NR8PkUjV2W/SpKEOZ5FKbt5pZsiaIvU"
      crossorigin="anonymous"
    ></script>
    <script
